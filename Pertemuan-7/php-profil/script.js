...
// ===== FETCH API: FAKTA RANDOM DARI BERBAGAI KATEGORI =====
...
async function ambilFakta() {
    ...
    try {
        // Daftar semua API endpoint
        const endpoints = [
            "https://api.ryocantsleep.com/api/cysecfacts",
            "https://api.ryocantsleep.com/api/aifacts",
            "https://api.ryocantsleep.com/api/filmmakingfacts",
            "https://api.ryocantsleep.com/api/designfacts",
            "https://api.ryocantsleep.com/api/audiofacts",
            "https://api.ryocantsleep.com/api/languagefacts",
            "https://api.ryocantsleep.com/api/gamedevfacts",
            "https://api.ryocantsleep.com/api/bookfacts"
        ];

        // Pilih satu endpoint secara acak
