# Penjelasan Teknis Kode Profil (Pertemuan 4)
...
- `class="header-content"`: Memberikan kelas khusus agar elemen ini bisa ditata secara spesifik di CSS (seperti penerapan Flexbox pada header).
